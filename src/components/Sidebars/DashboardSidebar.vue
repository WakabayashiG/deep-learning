<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="images/Yıldız_Technical_University_Logo.png" alt=""> <span>Deep Learning</span></div>
			<hr>

			<!-- Sidebar Navigation Menu -->
			<a-menu theme="light" mode="inline">
        <a-menu-item>
          <router-link to="/feed-forward">
						<span class="icon">
            ...
            <span class="label">Feed Forward</span>
          </router-link>
        </a-menu-item>
